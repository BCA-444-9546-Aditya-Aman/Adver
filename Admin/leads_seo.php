...
$seo_leads = getLeads($pdo, 'seo_leads', $filter_month, $filter_status, $sort);

$total_leads = count($seo_leads);
$total_won = 0; $total_lost = 0;
foreach ($seo_leads as $l) {
...
<div class="dashboard-section active" id="tab-seo">
    <div class="content-header"><div class="header-title"><h1>SEO Audit Leads</h1><p>Enquiries collected from SEO service forms.</p></div></div>
    ...
    <div class="table-card" style="margin-top: 20px;">
        <div class="card-header">
            ...
            <div class="card-actions">
                ...
                <a href="export.php?type=seo&filter_month=<?php echo urlencode($filter_month); ?>&filter_status=<?php echo urlencode($filter_status); ?>&sort=<?php echo urlencode($sort); ?>" class="btn btn-outline"><i class="fa-solid fa-download"></i> Export CSV</a>
            </div>
        </div>
        <div class="table-responsive">
            <table id="seoTable">
                ...
                <?php if (empty($seo_leads)): ?>
                    <tr><td colspan="5" class="no-leads"><i class="fa-regular fa-folder-open"></i> No SEO leads captured yet.</td></tr>
                <?php else: ?>
                    <?php foreach ($seo_leads as $lead): $lead_js = array_merge($lead, ['lead_type' => 'seo', 'display_type' => 'SEO']); ?>
...
?>
                        ...
                        <td><span class="badge badge-seo" style="font-size:10px;"><?php echo htmlspecialchars($lead['seo_need']); ?></span></td>
