...
$web_leads = getLeads($pdo, 'web_leads', $filter_month, $filter_status, $sort, $from_date, $to_date, $current_admin_id);
    ...
    <div class="table-card" style="margin-top: 20px;">
        <div class="card-header">
            ...
            <div class="card-actions">
                <span class="lead-count-badge"><i class="fa-solid fa-list-check" style="margin-right: 5px;"></i> Total: <strong><span id="header-total-count"><?php echo count($web_leads); ?></span></strong></span>
