...
$smm_leads = getLeads($pdo, 'smm_leads', $filter_month, $filter_status, $sort, $from_date, $to_date, $current_admin_id);
    ...
    <div class="table-card" style="margin-top: 20px;">
        <div class="card-header">
            ...
            <div class="card-actions">
                <span class="lead-count-badge"><i class="fa-solid fa-list-check" style="margin-right: 5px;"></i> Total: <strong><span id="header-total-count"><?php echo count($smm_leads); ?></span></strong></span>
                <a href="export.php?type=smm&filter_month=<?php echo urlencode($filter_month); ?>&filter_status=<?php echo urlencode($filter_status); ?>&sort=<?php echo urlencode($sort); ?>&from_date=<?php echo urlencode($from_date); ?>&to_date=<?php echo urlencode($to_date); ?>" class="btn btn-outline"><i class="fa-solid fa-download"></i> Export CSV</a>
            </div>
        </div>
