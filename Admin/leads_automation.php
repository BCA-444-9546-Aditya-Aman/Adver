...
$automation_leads = getLeads($pdo, 'automation_leads', $filter_month, $filter_status, $sort);
    ...
    <div class="table-card" style="margin-top: 20px;">
        <div class="card-header">
            ...
            <div class="card-actions">
                <span class="lead-count-badge"><i class="fa-solid fa-list-check" style="margin-right: 5px;"></i> Total: <strong><?php echo count($automation_leads); ?></strong></span>
                <a href="export.php?type=automation&filter_month=<?php echo urlencode($filter_month); ?>&filter_status=<?php echo urlencode($filter_status); ?>&sort=<?php echo urlencode($sort); ?>" class="btn btn-outline"><i class="fa-solid fa-download"></i> Export CSV</a>
            </div>
        </div>
